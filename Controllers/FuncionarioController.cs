...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Deletar(int id)
    {
        ...
        // Chamar o método de Remove do _context.Funcionarios para salvar no Banco SQL // feito!!
        ...
        tableClient.UpsertEntity(funcionarioLog);
        // TODO: Chamar o método UpsertEntity para salvar no Azure Table // feito!!
